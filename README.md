...
| Platform | Download                                |
|----------|-----------------------------------------|
| iOS      | <a target="_blank" href="https://apps.apple.com/ca/app/tensor-camera/id6476598066?platform=iphone"><img  src="/assets/APPLE.png" alt="iOS Download" title="App Store Link" height="50"></a>  |
